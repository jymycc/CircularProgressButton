...
class MorphingAnimation {
    ...
    public static final int DURATION_BACK_SHORT = 100;
    public static final int DURATION_INSTANT = 1;

    private OnAnimationStartListener mStartListener;
    ...
    public void setStartListener(OnAnimationStartListener listener) {
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                if (null != mStartListener) {
                    mStartListener.onAnimationStart();
                }
            }
