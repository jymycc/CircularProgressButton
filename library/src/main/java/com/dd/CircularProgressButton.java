...
public class CircularProgressButton extends Button {
    ...
    public enum State {
        PROGRESS, IDLE, COMPLETE, ERROR, MORPHING
    }
    ...
    private MorphingAnimation createMorphing() {
        ...
        if (mConfigurationChanged) {
            ...
            animation.setDuration(MorphingAnimation.DURATION_BACK_SHORT);
        }
    ...
    private void morphToProgress() {
        ...
        animation.setStartListener(mProgressStateStartListener);
        animation.setListener(mProgressStateListener);

        animation.start();
    }

    private OnAnimationStartListener mProgressStateStartListener = new OnAnimationStartListener() {
        @Override
    ...
    private void morphProgressToComplete() {
        ...
        animation.setStartListener(mCompleteStateStartListener);
    ...
    private OnAnimationStartListener mCompleteStateStartListener = new OnAnimationStartListener() {
        @Override
        public void onAnimationStart() {
            mMorphingInProgress = false;
            mState = State.MORPHING;
    ...
    private void morphCompleteToIdle() {
        ...
        animation.setStartListener(mIdleStateStartListener);
    ...
    private OnAnimationStartListener mIdleStateStartListener = new OnAnimationStartListener() {
        @Override
        public void onAnimationStart() {
            mMorphingInProgress = false;
            mState = State.MORPHING;
